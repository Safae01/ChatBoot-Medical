...
// Données d'exemple pour les rendez-vous du médecin
...
interface MedecinRendezVousTabProps {
  onViewDossier: (patient: any) => void
}

export function MedecinRendezVousTab({ onViewDossier }: MedecinRendezVousTabProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {rendezVousData.length} rendez-vous programmés
          </p>
        </div>
      </div>
                ...
                <tr key={rdv.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button
                      ...
                      className="text-blue-600 hover:text-blue-900 flex items-center space-x-1 hover:bg-blue-50 px-2 py-1 rounded transition-colors"
                    >
