...
// Données d'exemple pour les questions
const initialQuestionsData = [
  ...
  { 
    id: 5, 
    question: "Décrivez la douleur sur une échelle de 1 à 10", 
    medecin: "Dr. Petit",
    categorie: "Douleur",
...
export function AdminQuestionsTab({}: AdminQuestionsTabProps) {
  ...
  const filteredQuestions = questions.filter(question => {
    const matchesSearch = 
      ...
      question.medecin.toLowerCase().includes(searchTerm.toLowerCase())
    
    const matchesCategory = categoryFilter === "" || question.categorie === categoryFilter
    const matchesMedecin = medecinFilter === "" || question.medecin === medecinFilter
    
    return matchesSearch && matchesCategory && matchesMedecin
  })
  ...
  const uniqueMedecins = Array.from(new Set(questions.map(q => q.medecin)))
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Gestion des Questions Chatbot</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-green-50 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-green-900 mt-1">{uniqueMedecins.length}</p>
        </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-6 text-sm text-gray-600">
                  <div className="flex items-center space-x-1">
                    ...
                    <span>{question.medecin}</span>
                  </div>
                  <div>
                    <span>Créée le {question.dateCreation}</span>
                  </div>
                  <div>
                    <span className="font-medium text-green-600">{question.utilise} utilisations</span>
                  </div>
                </div>
              </div>
      ...
      {filteredQuestions.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            {searchTerm || categoryFilter || medecinFilter 
